    ...
    return {
      Property: (node) => {
        ...
        if (queryKeyNode.type === AST_NODE_TYPES3.Identifier) {
          ...
          if (expression?.type === AST_NODE_TYPES3.ArrayExpression) {
...
function isIllegalReturn(checker, type) {
  ...
  return awaited.flags & (ts.TypeFlags.Void | ts.TypeFlags.Undefined) ? true : false;
}
...
//# sourceMappingURL=chunk-6ZHBB3IQ.js.map